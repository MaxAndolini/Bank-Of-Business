...
public class Customers extends javax.swing.JPanel {
    ...
    public Customers(swing.Home home) {
        ...
        timer = new Timer(2000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (text == null) {
                    data = Database.getArrayList("Accounts", "AccountType", 0);
                } else {
                    data = Database.getArrayList("Accounts", "AccountType", 0, typename[type], text);
                }
    ...
    private void initComponents() {
        ...
        jScrollPane.setViewportView(customersTable);
