...
public class Transactions extends javax.swing.JPanel {
    ...
    public Transactions(swing.Home home) {
        ...
        timer = new Timer(2000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (text == null) {
                    data = Database.getArrayList("Transactions");
                } else {
                    String ID;
                    if (type == 0) {
                        ID = text;
                    ...
                    data = Database.getArrayList("Transactions", "Account", ID);
                }
                if (load == null || (data != null && !load.equals(data))) {
                    ...
                    Integer columns[] = {0, 1, 2, 3, 4, 5, 6, 7};
    ...
    private void initComponents() {
        ...
        transactionsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Account", "Transaction", "Type", "Amount", "Transfer To", "Transfer From", "Date & Time"
            }
        ) {
